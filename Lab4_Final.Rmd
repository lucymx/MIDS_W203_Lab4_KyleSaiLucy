...
The practical significance of the percent of young males in a county stands out from the rest. In this model, the effect of a unit increase in the percentage of young males is near .115  crimes per person. Therefore, a one standard deviation change in the percentage of young males results in a change of .002 crimes per person, which represents only a tenth of the standard deviation of crime rate. In this we see that, though the coefficient on the percentage of males seems high, it may not carry that much practical weight.
